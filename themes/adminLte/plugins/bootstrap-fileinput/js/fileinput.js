...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgSizeTooSmall: 'Selected file (<b>{size} KB</b>) is too small and must be larger than <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'Selected file (<b>{size} KB</b>) exceeds maximum allowed upload size of <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'You must select at least <b>{n}</b> {files} to upload.',
        msgFilesTooMany: 'Number of files selected for upload <b>({n})</b> exceeds maximum allowed limit of <b>{m}</b>.',
        msgFileNotFound: 'File not found!',
        msgFileSecured: 'Security restrictions prevent reading the file.',
        msgFileNotReadable: 'File is not readable.',
        msgFilePreviewAborted: 'File preview aborted.',
        msgFilePreviewError: 'An error occurred while reading the file.',
        msgInvalidFileName: 'Invalid or unsupported characters in file name.',
        msgInvalidFileType: 'Invalid file type. Only "{types}" files are supported.',
