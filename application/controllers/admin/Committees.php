...
class Committees extends Custom_Controller {
    ...
    public function __construct() {
        ...
        $this->controllerName = "committees";
        $this->singular = "Committee";
        $this->plural = "Committees";
    }
    ...
    public function index($id = "") {
        ...
        if ($id == "") {
            ...
            $data['item'] = $this->Committee_model->get_record($id);
        }
    ...
    public function data_list() {
        ...
        $dataList = $this->Committee_model->get_datatables("", $sWhere, $start, $length, "id", "DESC");
        $dataListCount = $this->Committee_model->get_datatables("", $sWhere);
    ...
    public function add() {
        ...
        if (isset($_POST) && !empty($_POST)) {
            ...
            $menu = $this->Committee_model->add_record($data);
    ...
    public function edit($id) {
        ...
        if (isset($_POST) && !empty($_POST)) {
            ...
            $menu = $this->Committee_model->update_record($id, $data);
    ...
    public function delete($id) {
        ...
        $this->Committee_model->delete_record($id);
    ...
    public function deleteMultiple() {
        if (isset($_POST['id'])) {
            $ids = $_POST['id'];
            $this->Committee_model->delete_multiple($ids);
            $response = array(
                'errorcode' => 1,
                'action' => 'MUL_DELETE'
            );
