...
class Educations extends Custom_Controller {
    ...
    public function __construct() {
        ...
        $this->controllerName = "educations";
        $this->singular = "Education";
        $this->plural = "Educations";
    }
    ...
    public function index($id = "") {
        ...
        if ($id == "") {
            ...
            $data['item'] = $this->Education_model->get_record($id);
        }
    ...
    public function data_list() {
        ...
        $dataList = $this->Education_model->get_datatables("", $sWhere, $start, $length, "id", "DESC");
        $dataListCount = $this->Education_model->get_datatables("", $sWhere);
    ...
    public function add() {
        ...
        if (isset($_POST) && !empty($_POST)) {
            ...
            $menu = $this->Education_model->add_record($data);
    ...
    public function edit($id) {
        ...
        if (isset($_POST) && !empty($_POST)) {
            ...
            $menu = $this->Education_model->update_record($id, $data);
    ...
    public function delete($id) {
        ...
        $this->Education_model->delete_record($id);
    ...
    public function deleteMultiple() {
        if (isset($_POST['id'])) {
            $ids = $_POST['id'];
            $this->Education_model->delete_multiple($ids);
            $response = array(
                'errorcode' => 1,
                'action' => 'MUL_DELETE'
            );
