...
class SubCommunity extends Custom_Controller {
    ...
    public function __construct() {
        ...
        $this->controllerName = "subCommunity";
        $this->singular = "Sub Community";
        $this->plural = "Sub Community";
    }
    ...
    public function index($id = "") {
        ...
        if ($id == "") {
            ...
            $data['item'] = $this->SubCommunity_model->get_record($id);
        }
    ...
    public function data_list() {
        ...
        $dataList = $this->SubCommunity_model->get_datatables("", $sWhere, $start, $length, "id", "DESC");
        $dataListCount = $this->SubCommunity_model->get_datatables("", $sWhere);
    ...
    public function add() {
        ...
        if (isset($_POST) && !empty($_POST)) {
            ...
            $menu = $this->SubCommunity_model->add_record($data);
    ...
    public function edit($id) {
        ...
        if (isset($_POST) && !empty($_POST)) {
            ...
            $menu = $this->SubCommunity_model->update_record($id, $data);
    ...
    public function delete($id) {
        ...
        $this->SubCommunity_model->delete_record($id);
    ...
    public function deleteMultiple() {
        if (isset($_POST['id'])) {
            $ids = $_POST['id'];
            $this->SubCommunity_model->delete_multiple($ids);
            $response = array(
                'errorcode' => 1,
                'action' => 'MUL_DELETE'
            );
