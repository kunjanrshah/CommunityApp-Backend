                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="fname">Sub Community<span class="kv-reqd">*</span></label>
                                    <select name="sub_community_id" id="sub_community_id" class="form-control" required="required">
                                        <option value="">--Select--</option>
                                        <?php
                                        if (!empty($subCommunity)) {
                                            foreach ($subCommunity as $data) {
                                                $selected = "";
                                                if (!empty($item) && $item['sub_community_id'] == $data['id']) {
                                                    $selected = "selected";
                                                }
                                                ?>
