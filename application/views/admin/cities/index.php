                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="fname">State<span class="kv-reqd">*</span></label>
                                    <select name="state_id" id="state_id" class="form-control" required="required">
                                        ...
                                        if (!empty($states)) {
                                            foreach ($states as $data) {
                                                $selected = "";
                                                if (!empty($item) && $item['state_id'] == $data['id']) {
                                                    $selected = "selected";
                                                }
                                                ?>
                                                <option <?= $selected ?> value="<?= $data['id'] ?>"><?= $data['state'] ?></option>
                                                <?php
                                            }
                                        }
                                        ?>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="fname">City Name<span class="kv-reqd">*</span></label>
                                    <input type="text" class="form-control" name="city" value="<?= (!empty($item)) ? $item['city'] : "" ?>" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <br>
