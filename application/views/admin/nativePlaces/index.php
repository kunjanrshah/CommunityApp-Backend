                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="fname">Distinct<span class="kv-reqd">*</span></label>
                                    <select name="distinct_id" id="distinct_id" class="form-control" required="required">
                                        <option value="">--Select--</option>
                                        <?php
                                        if (!empty($distincts)) {
                                            foreach ($distincts as $data) {
                                                $selected = "";
                                                if (!empty($item) && $item['distinct_id'] == $data['id']) {
                                                    $selected = "selected";
                                                }
                                                ?>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="fname">Native Place<span class="kv-reqd">*</span></label>
                                    <input type="text" class="form-control" name="native" value="<?= (!empty($item)) ? $item['native'] : "" ?>" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <br>
